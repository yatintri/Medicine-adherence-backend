...
public class MedicineController {
    ...
    public ResponseEntity<?> saveUserMedicine(@PathVariable("id") String id, @RequestBody UserMedicines userMedicines){
    ...
    public ResponseEntity<?> updateMedicineStatus(@PathVariable("id") String med_id){
    ...
    public ResponseEntity<?> getUserMedicines(@PathVariable("id") String user_id) throws ExecutionException, InterruptedException {
    ...
    public ResponseEntity<?> editMedicineDetails(@PathVariable("id") String id,
                                               @RequestBody UserMedicines userMedicines) throws UserexceptionMessage {
